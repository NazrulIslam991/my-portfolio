...
const experienceData = {
  junior: {
    ...
    company: "@ Softvence Delta, Dhaka",
    duration: "APR 2026 — MAY 2026",
    points: [
      "Architecting scalable mobile apps using <strong class='text-slate-200'>MVVM Architecture</strong> and Riverpod.",
      "Integrating complex <strong class='text-slate-200'>REST APIs</strong> via Dio.",
      "Translating Figma designs into pixel-perfect Flutter widgets.",
      "Managing real-time backend with <strong class='text-slate-200'>Firebase</strong>.",
    ],
    tags: [
      "Flutter/Dart",
      "Clean Architecture",
  ...
  trainee: {
    ...
    points: [
      "Intensive training on <strong class='text-slate-200'>Dart & Flutter</strong> fundamentals.",
      "Assisted debugging and optimizing client projects.",
      "Implemented UI components from design specs.",
      "Learned <strong class='text-slate-200'>Agile/Scrum</strong> workflows.",
    ],
  ...
  bio: {
    ...
    details: [
      ...
      { icon: "fa-flag", label: "Nationality", value: "Bangladeshi" },
      {
        ...
        label: "Location",
        value: "Banasree, Rampura, Dhaka",
      },
      {
        icon: "fa-envelope",
        label: "Email",
        value: "nazrulislamnayon991@gmail.com",
      },
      {
        icon: "fa-language",
        label: "Languages",
    ...
    categories: [
      {
        ...
        value:
          "Flutter, Dart, Native Android (Java/Kotlin), Cross-Platform Development, Responsive UI",
      },
      {
      ...
      },
      {
        label: "API & Backend",
        value:
          "RESTful APIs (Dio), JSON Parsing, JWT, Firebase (FCM), Socket.io, Cloudinary",
      },
      {
        label: "Features & Integration",
        value:
          "Google Maps, Stripe Payment, Real-time Tracking, OCR, Localization, Caching",
      },
      {
        label: "Tools & Platforms",
        value:
          "Git/GitHub, Postman, FVM, Android Studio, VS Code, SharedPreferences",
      },
    ],
  },
  cert: {
    ...
    details: [
      {
        ...
        credentialId: "C35483",
        description:
          "Certified in advanced state management (Riverpod), clean architecture, and enterprise-grade API orchestration.",
        tags: ["CLEAN ARCHITECTURE", "GETX", "FLUTTER"],
        validateLink:
          "https://drive.google.com/file/d/1RBx1BggH6bNYfx8oLt9y-rD0nsx3okaC/view?usp=sharing",
      },
    ],
  },
};
...
window.updateExperience = function (key) {
  ...
  setTimeout(() => {
    ...
    let tagsHTML = data.tags
      .map(
        (t) => `
            <span class="bg-white/5 border border-white/10 px-3 py-1 rounded-lg text-[10px] sm:text-xs text-slate-300 hover:border-emerald-500/50 transition-colors cursor-default">${t}</span>`,
      )
      .join("");
  ...
  setTimeout(() => {
    ...
    if (data.categories) {
      ...
      const iconMap = {
        ...
        "Backend/DB": "fa-database",
        "State Management": "fa-layer-group",
        "Collaboration & Tools": "fa-tools",
      };
...
document.querySelectorAll(".project-slider").forEach((sliderContainer) => {
